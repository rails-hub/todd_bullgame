...
<body>
<div class="container-fluid" style="background: #F7F7F9;min-height: 700px">
    ...
    <p>
        ...
        understand
        how we collect, use, communicate and disclose and make use of personal information. The following outlines
        our
        privacy policy.
    </p>
